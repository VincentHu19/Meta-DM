...
class Data:
    def __init__(self, data_dir):        
        ...
        self.K_mtr = 128 # total num meta_train classes
        self.K_mva = 32 # total num meta_val classes
        self.K_mte = 40 # total num meta_test classes
        ...
        dim = x_mva.shape[-1]
        x_mva = np.reshape(x_mva, [32,600,dim])
        
        x_mte = np.load(os.path.join(data_dir, 'test_features.npy'))
        x_mte = np.reshape(x_mte, [40,600,dim])
